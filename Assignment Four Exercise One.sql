...
insert into products (product_id, product_name, category_id, description) values
  (1, 'Smartphone X', 1, 'A high-end smartphone with advanced features.'),
  (2, 'Laptop Pro', 1, 'Powerful laptop for professional use.'),
  (3, 'T-shirt', 2, 'Comfortable cotton T-shirt in various colors.'),
  (4, 'Garden Tools Kit', 3, 'Complete set of gardening tools for enthusiasts.'),
  (5, 'Bestseller Novel', 4, 'New York Times bestseller novel by a renowned author.'),
  (6, 'LEGO City Set', 5, 'Build your own city with this LEGO set.'),
  (7, 'Outdoor Adventure Gear', 6, 'Gear for hiking, camping, and outdoor activities.'),
  (8, 'Skincare Bundle', 7, 'A bundle of skincare products for a healthy skin regimen.'),
  (9, 'Car Maintenance Kit', 8, 'Essential tools and products for car maintenance.'),
  (10, 'Acoustic Guitar', 9, 'A high-quality acoustic guitar for music enthusiasts.');
...
create index composite_index on order_items (order_id, product_id);
create index order_date on orders (order_date);
-- drop index customer_id, composite_index, order_date;
